...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "Clipboard|DOMError|DOMImplementation|DataTransfer|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["crypto", "package:crypto/crypto.dart", , M, {
  ...
  _HashBase: {
    ...
    _bytesToChunk$2: function(data, dataIndex) {
      var t1, t2, t3, t4, t5, wordIndex, w3, t6, w2, w1, w0;
      for (t1 = this._chunkSizeInWords, t2 = this._currentChunk, t3 = t2.length, t4 = data.length, t5 = this._bigEndianWords, wordIndex = 0; wordIndex < t1; ++wordIndex) {
        if (t5) {
          if (dataIndex >= t4)
        ...
        t2[wordIndex] = ((w3 & 255) << 24 | (w2 & 255) << 16 | (w1 & 255) << 8 | w0 & 255) >>> 0;
      }
    },
  ...
  SHA1: {
    ...
    _updateHash$1: function(m) {
      ...
      for (t2 = this._w, t3 = m.length, i = 0; i < 80; ++i, e = d, d = c, c = c0, b = a, a = a0) {
        if (i < 16) {
          ...
          if (typeof t7 !== "number")
            return H.iae(t7);
          n = t4 ^ t5 ^ t6 ^ t7;
          t7 = (n << 1 & 4294967295 | (n & 4294967295) >>> 31) >>> 0;
          t2[i] = t7;
          t4 = t7;
        }
        if (typeof a !== "number")
        ...
        if (typeof t4 !== "number")
          return H.iae(t4);
        t = (((((a << 5 & 4294967295 | (a & 4294967295) >>> 27) >>> 0) + e & 4294967295) >>> 0) + t4 & 4294967295) >>> 0;
        if (i < 20) {
          if (typeof b !== "number")
            return b.$and();
          if (typeof c !== "number")
          ...
          if (typeof d !== "number")
            return H.iae(d);
          t = ((t + ((b & c | b & d | c & d) >>> 0) & 4294967295) >>> 0) + 2400959708 & 4294967295;
        } else {
          if (typeof b !== "number")
            return b.$xor();
          if (typeof c !== "number")
          ...
          if (typeof d !== "number")
            return H.iae(d);
          t = ((t + ((b ^ c ^ d) >>> 0) & 4294967295) >>> 0) + 3395469782 & 4294967295;
        }
        if (typeof b !== "number")
          return b.$shl();
      ...
      if (typeof t2 !== "number")
        return H.iae(t2);
      t1[0] = (a + t2 & 4294967295) >>> 0;
      t2 = t1[1];
      if (typeof b !== "number")
        return b.$add();
      if (typeof t2 !== "number")
        return H.iae(t2);
      t1[1] = (b + t2 & 4294967295) >>> 0;
      t2 = t1[2];
      if (typeof c !== "number")
        return c.$add();
      if (typeof t2 !== "number")
        return H.iae(t2);
      t1[2] = (c + t2 & 4294967295) >>> 0;
      t2 = t1[3];
      if (typeof d !== "number")
        return d.$add();
      if (typeof t2 !== "number")
...
["dart.dom.html", "dart:html", , W, {
  ...
  InputElement: {
    "^": "HtmlElement;files=,name=,size=,value%",
    $isElement: true,
    "%": "HTMLInputElement"
  },
  KeygenElement: {
...
["hetima", "package:hetima/hetima.dart", , V, {
  ...
  TorrentFile: {
    ...
    static: {"^": "TorrentFile_KEY_ANNOUNCE,TorrentFile_KEY_NAME,TorrentFile_KEY_INFO,TorrentFile_KEY_FILES,TorrentFile_KEY_LENGTH,TorrentFile_KEY_PIECE_LENGTH,TorrentFile_KEY_PIECE,TorrentFile_KEY_PATH"}
  },
  TorrentFileCreator: {
  ...
  TorrentFileCreator_createFromSingleFile_closure: {
    "^": "Closure:21;this_0,target_1,ret_2,helper_3",
    call$1: function(targetLength) {
      var t1, compleater, t2, result;
      t1 = this.this_0;
      compleater = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      t2 = new V.ArrayBuilder(1024, null, 0);
      t2._buffer8 = new Uint8Array(1024);
      result = new V.CreatePieceHashResult(0, 0, t2, null);
      result.pieceLength = t1.piececSize;
      result.targetFile = this.target_1;
      this.helper_3._createPieceHash$2(compleater, result);
      compleater.future.then$1(new V.TorrentFileCreator_createFromSingleFile__closure(t1, this.ret_2, targetLength));
    }
  },
  TorrentFileCreator_createFromSingleFile__closure: {
    "^": "Closure:22;this_4,ret_5,targetLength_6",
    call$1: function(r) {
  ...
  TorrentPieceHashCreator__createPieceHash_closure: {
    "^": "Closure:21;box_0,this_1,compleater_2,result_3,start_4",
  ...
  TorrentPieceHashCreator__createPieceHash__closure: {
    "^": "Closure:23;box_0,this_5,compleater_6,result_7,start_8,length_9",
    call$1: function(e) {
      var sha1, t1, t2, t3;
      sha1 = new M.SHA1(Array(80), 16, 5, true, 0, [], Array(16), Array(5), false);
      sha1.SHA1$0();
      t1 = this.box_0;
      t2 = J.sublist$2$ax(J.get$buffer$x(e), this.start_8, t1.end_0);
      if (sha1._digestCalled)
        H.throwExpression(P.StateError$("Hash update method called after digest was retrieved"));
      sha1._lengthInBytes = sha1._lengthInBytes + t2.length;
      C.JSArray_methods.addAll$1(sha1._pendingData, t2);
      sha1._iterate$0();
      t2 = this.result_7;
      t3 = sha1.close$0(0);
  ...
  ArrayBuilder: {
    "^": "Object;_max,_buffer8,_hetima$_length",
...
["", "torrentfilecreator.dart", , Z, {
  "^": "",
  main: [function() {
    var drugdtopTag, fileSelector, announceField, nameField, result, t1, t2;
    drugdtopTag = W.Element_Element$html("<div id=\"drugdrop\">drug drop</div>", null, null);
    fileSelector = W.Element_Element$html("<input type=\"file\" id=\"files\" name=\"file\" />", null, null);
    announceField = W._ElementFactoryProvider_createElement_tag("textarea", null);
    nameField = W._ElementFactoryProvider_createElement_tag("textarea", null);
    J.set$value$x(announceField, "http://www.example.com/announce:6969");
    J.set$value$x(nameField, "test.data");
    result = W._ElementFactoryProvider_createElement_tag("textarea", null);
    t1 = J.getInterceptor$x(drugdtopTag);
    t2 = t1.get$onDrop(drugdtopTag);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Z.main_closure(announceField, nameField, result)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = t1.get$onDragOver(drugdtopTag);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Z.main_closure0()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    t2 = J.get$onChange$x(fileSelector);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Z.main_closure1(fileSelector, announceField, nameField, result)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    ...
    t1 = document.body;
    t1.children;
    t1.appendChild(W.Element_Element$html("<div> announce </div>", null, null));
    document.body.appendChild(announceField);
    t1 = document.body;
    t1.children;
    t1.appendChild(W._ElementFactoryProvider_createElement_tag("br", null));
    t1 = document.body;
    t1.children;
    t1.appendChild(W.Element_Element$html("<div> name </div>", null, null));
    document.body.appendChild(nameField);
    t1 = document.body;
    t1.children;
    t1.appendChild(W._ElementFactoryProvider_createElement_tag("br", null));
    document.body.appendChild(drugdtopTag);
    t1 = document.body;
    t1.children;
    t1.appendChild(W._ElementFactoryProvider_createElement_tag("br", null));
  ...
  createTorrent: function(f, announce, $name, output) {
    var file, creator, t1, t2, result, line;
    file = new N.HetimaFileBlob(null);
    file._mBlob = f;
    creator = new V.TorrentFileCreator("http://127.0.0.1:6969", "name", 16384);
    creator.announce = announce;
    creator.name = $name;
    t1 = creator.createFromSingleFile$1(file);
    t2 = $.Zone__current;
    t2.toString;
    result = new P._Future(0, t2, null, null, new Z.createTorrent_closure(output), null, P._registerErrorHandler(null, t2), null);
  ...
  main_closure: {
    "^": "Closure:26;announceField_0,nameField_1,result_2",
    call$1: function(e) {
      var t1 = J.getInterceptor$x(e);
      t1.stopPropagation$0(e);
      e.preventDefault();
      t1 = C.FileList_methods.get$iterator(t1.get$dataTransfer(e).files);
      $loop$0: {
        if (t1.moveNext$0()) {
          Z.createTorrent(t1._current, J.get$value$x(this.announceField_0), J.get$value$x(this.nameField_1), this.result_2);
          break $loop$0;
        }
      }
    }
  ...
  main_closure1: {
    "^": "Closure:25;fileSelector_3,announceField_4,nameField_5,result_6",
    call$1: function(e) {
      var t1, f, line;
      t1 = C.FileList_methods.get$iterator(J.get$files$x(this.fileSelector_3));
      $loop$0: {
        if (t1.moveNext$0()) {
          f = t1._current;
          line = C.JSString_methods.$add("==", J.get$name$x(f));
          H.printString(line);
          Z.createTorrent(f, J.get$value$x(this.announceField_4), J.get$value$x(this.nameField_5), this.result_6);
          break $loop$0;
        }
      }
    }
  },
  createTorrent_closure: {
    "^": "Closure:27;output_0",
    call$1: function(e) {
      J.set$value$x(this.output_0, "##:" + C.JsonCodec_null_null.encode$1(e.get$torrentFile().mMetadata));
    }
  }
},
1],
...
V.TorrentFileCreatorResult.$isTorrentFileCreatorResult = true;
V.TorrentFileCreatorResult.$isObject = true;
P.Symbol.$isSymbol = true;
P.Symbol.$isObject = true;
P.bool.$isbool = true;
P.bool.$isObject = true;
V.CreatePieceHashResult.$isCreatePieceHashResult = true;
V.CreatePieceHashResult.$isObject = true;
...
function dart_precompiled($collectedClasses) {
  ...
  File.prototype.get$relativePath = function(receiver) {
  ...
  function ArrayBuilder(_max, _buffer8, _hetima$_length) {
    this._max = _max;
  ...
  function main_closure(announceField_0, nameField_1, result_2) {
    this.announceField_0 = announceField_0;
    this.nameField_1 = nameField_1;
  ...
  function main_closure1(fileSelector_3, announceField_4, nameField_5, result_6) {
    this.fileSelector_3 = fileSelector_3;
    this.announceField_4 = announceField_4;
    this.nameField_5 = nameField_5;
