...
["", "torrentfileparser.dart", , O, {
  ...
  main: [function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.main_closure(announceField, nameField, result)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
  ...
  createTorrent: function(f, announce, $name, output) {
    ...
    t2 = $.Zone__current;
    t2.toString;
    result = new P._Future(0, t2, null, null, new O.createTorrent_closure(output), null, P._registerErrorHandler(null, t2), null);
  ...
  main_closure: {
    ...
    call$1: function(e) {
      ...
      $loop$0: {
        if (t1.moveNext$0()) {
          O.createTorrent(t1._current, J.get$value$x(this.announceField_0), J.get$value$x(this.nameField_1), this.result_2);
          break $loop$0;
        }
      }
    }
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure1(fileSelector_3) {
