...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder: {
    ...
    convert$3: function(codeUnits, startIndex, endIndex) {
      var t1, value, expectedUnits, extraUnits, t2, t3, t4, i, t5, unit, i0, to;
      t1 = {};
      ...
      $loop$0:
        for (t3 = this._stringSink, t4 = this._allowMalformed !== true, i = startIndex; true; i = i0) {
          $multibyte$2: {
            if (expectedUnits > 0) {
              t5 = codeUnits.length;
              do {
                ...
                if ((unit & 192) !== 128) {
                  ...
                  t5 = H.Primitives_stringFromCharCode(65533);
                  t3._contents += t5;
                  expectedUnits = 0;
                  break $multibyte$2;
                } else {
              ...
              if (!this._isFirstCharacter || value !== 65279) {
                t5 = H.Primitives_stringFromCharCode(value);
                t3._contents += t5;
              }
              this._isFirstCharacter = false;
            }
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:18;box_0,this_1,codeUnits_2",
    call$2: function(from, to) {
      var t1, t2, t3;
      t1 = from === 0 && to === this.codeUnits_2.length;
      t2 = this.this_1;
      t3 = this.codeUnits_2;
      if (t1)
        t2._stringSink.write$1(P.String_String$fromCharCodes(t3));
      else
        t2._stringSink.write$1(P.String_String$fromCharCodes(C.JSArray_methods.sublist$2(t3, from, to)));
...
["hetima", "package:hetima/hetima.dart", , V, {
  ...
  Bdecoder: {
    ...
    decodeBenObject$1: function(buffer) {
      var t1, t2, ret;
      t1 = J.$index$asx(buffer, this.index);
      if (typeof t1 !== "number")
        return H.iae(t1);
      if (48 <= t1) {
        t1 = this.index;
        if (t1 >>> 0 !== t1 || t1 >= buffer.length)
      ...
      if (t1)
        ...
        if (105 === t2)
          ...
          this.index = t1;
          if (t2 !== 108)
            H.throwExpression(V.ParseError$("benlist", buffer, t1));
          ...
          if (t1 >>> 0 !== t1 || t1 >= buffer.length)
            return H.ioore(buffer, t1);
          if (buffer[t1] !== 101)
            H.throwExpression(V.ParseError$("benlist", buffer, t2));
          return ret;
        } else if (100 === t2) {
          ...
          if (t1 >>> 0 !== t1 || t1 >= buffer.length)
            return H.ioore(buffer, t1);
          if (buffer[t1] !== 100)
            H.throwExpression(V.ParseError$("bendiction", buffer, t2));
      ...
      throw H.wrapException(V.ParseError$("benobject", buffer, t1));
    },
    ...
    decodeNumber$1: function(buffer) {
      var t1, $returnValue, t2, t3;
      t1 = this.index;
      if (typeof t1 !== "number")
        return t1.$add();
      this.index = t1 + 1;
      if (J.$index$asx(buffer, t1) !== 105)
        throw H.wrapException(V.ParseError$("bennumber", buffer, this.index));
      $returnValue = 0;
      while (true) {
        t1 = this.index;
        t2 = buffer.length;
        ...
        if (typeof t3 !== "number")
          return H.iae(t3);
        if (!(48 <= t3 && t3 <= 57))
          throw H.wrapException(V.ParseError$("bennumber", buffer, t1));
        this.index = t1 + 1;
        if (t1 >>> 0 !== t1 || t1 >= t2)
          return H.ioore(buffer, t1);
        $returnValue = $returnValue * 10 + (t3 - 48);
      }
      t3 = t1 + 1;
      this.index = t3;
      if (t1 >>> 0 !== t1 || t1 >= t2)
        return H.ioore(buffer, t1);
      if (buffer[t1] !== 101)
        throw H.wrapException(V.ParseError$("bennumber", buffer, t3));
      return $returnValue;
    },
    decodeBytes$1: function(buffer) {
      ...
      while (true) {
        ...
        if (typeof t3 !== "number")
          return H.iae(t3);
        if (!(48 <= t3 && t3 <= 57))
          throw H.wrapException(V.ParseError$("benstring", buffer, t2));
        this.index = t2 + 1;
      ...
      if (t2 >>> 0 !== t2 || t2 >= buffer.length)
        return H.ioore(buffer, t2);
      if (buffer[t2] !== 58)
        throw H.wrapException(V.ParseError$("benstring", buffer, t3));
      ret = new Uint8Array(H._ensureNativeList(t1.sublist$2(buffer, t3, t3 + $length)));
      t1 = this.index;
      if (typeof t1 !== "number")
        return t1.$add();
  ...
  ParseError: {
    ...
    ParseError$3: function(s, buffer, index) {
      this.log = s + "#" + H.IterableMixinWorkaround_toStringIterable(J.toList$0$ax(buffer), "[", "]") + "index=" + J.toString$0(index) + ":" + P.Object.prototype.toString$0.call(this, this);
    },
    static: {ParseError$: function(s, buffer, index) {
        var t1 = new V.ParseError("");
        t1.ParseError$3(s, buffer, index);
        return t1;
      }}
  }
}],
["", "torrentfileparser.dart", , O, {
  "^": "",
  main: [function() {
    var drugdtopTag, fileSelector, result, t1, t2;
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new O.main_closure(result)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
  ...
  createTorrentFileInfo: function(buffer) {
    ...
    try {
      t1 = $.get$Bencode__decoder();
      t1.index = 0;
      o = t1.decodeBenObject$1(buffer);
      t1 = "ok:" + C.JsonCodec_null_null.encode$1(o);
      return t1;
    } catch (exception) {
      t1 = H.unwrapException(exception);
      $E = t1;
      return C.JSString_methods.$add("error:", J.toString$0($E));
    }
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure(result_0) {
  ...
  function main_closure1(fileSelector_1, result_2) {
    this.fileSelector_1 = fileSelector_1;
